...
**[Botania](https://botaniamod.net/) by Vazkii and contributors.**
...
**Original mystical flower artwork by [wiiv](https://github.com/wiiv).** The flower textures shipped with Might & Magic are Scale2x upscales of wiiv's original 16×16 pixel art from Botania, used as a starting point for our own redraws. We are grateful for work that set the visual standard for magical flowers in Minecraft.

Botania assets and mechanical patterns are used under the [Botania license](https://github.com/VazkiiMods/Botania/blob/master/LICENSE.txt):
- Attribution to Vazkii and wiiv ✓ (this page)
- Source open and redistributable ✓ (see [GitHub](https://github.com/mjnetmods/might-and-magic))
