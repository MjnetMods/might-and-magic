...
Wearable trinkets with passive effects, Verdant-themed adaptations of Botania's accessory system.

> Portable Mana/Nox storage (Gems, Tablets, Rings) moved to [[magic/17_trinkets]] — that's generic cross-school infrastructure now, not Verdant-specific. This doc keeps only the named Trinket catalog below.

---

## Trinkets

Trinkets are crafted items with a passive effect. Like the Ring ([[magic/17_trinkets]]), each trinket is a **choice point**: wear it standalone in a curio slot for flexibility, or weave it permanently into a cloth armor piece at the Weavery.
...
| Item              | Status |
|-------------------|--------|
| Trinket catalog (16 items, slot affinity) | ✅ decided |
| Trinket recipes   | ⬜ not started |
