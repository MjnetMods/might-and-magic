...
| **Nox** | Purple | Dark school (primary producer) | Desecrated Pool |
...
- **Intent** — deliberately tainting a mana pool converts the quantity to Nox, bootstrapping dark school production
...
- [ ] **Nox generation** — what produces Nox to fill a Desecrated Pool? (dark flowers? corruption sources? ritual? TBD with dark school design)
- [ ] **Lava Apothecary** — which school uses it, and what does it produce? TBD with that school's design
- [ ] **Tainting mechanic** — how exactly is Nox introduced into a mana pool? Player action, proximity, item drop? TBD with dark school design
...
| Nox generation | ⬜ TBD — dark school design |
| Lava Apothecary school | ⬜ TBD |
| Blood fluid implementation | ⬜ TBD — Sanguine school design |
| Tainting trigger mechanic | ⬜ TBD — dark school design |
